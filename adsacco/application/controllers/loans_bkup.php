					...
					if($loan_id){
							...
							if(null != $loan){
									...
									if(null != $cash_account && null != $collection_account){
												...
												$payment_code = $loan_id.''.date('siHdmY').''.$cash_account->id;
							...
							$this->loan_transactions_model->insert_principal($loan_id,$loan->loan_principle_amount);
					...
					if($this->input->get_post('make_payment')){
						...
						if($loan_id){
							...
							$this->loan_transactions_model->add_transaction($loan_id,$trans,$trans_description,$is_credit,$total_pay_amount);
									...
									if( ($charges == 0) && ($payments == 0) && ($loan_balance_amount <= 0) ){
										$this->pay_model->update_points($loan['customer'], $loan_id);
