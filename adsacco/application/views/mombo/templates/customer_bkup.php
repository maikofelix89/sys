...
<ul class="breadcrumb">
	...
	<li class="active">Customer Detials</li>
</ul>
  ...
  <div class="well">
	...
	<div class="well">
	    <ul class="nav nav-tabs">
	      ...
	      <li>
	           <a href="#profile" data-toggle="tab">Employement Details</a>
	      </li>
	      <li>
		          ...
		          <table class="table">
		            <thead>
		                <tr class="muted">
		                     ...
		                     <th>Purpose For Loan Application</th>
		                     <th>Loan Status</th>
		                     <th></th>
		                </tr>
		            </thead>
			            ...
			            <?php foreach($loans->result('loan_model') as $loan){ ?>
				            <tr>
				              ...
				              <td>
				              	  ...
				              	  <h5 style="margin:0px;padding:0px;"><?php if($loan->loan_status == 0){ echo 'unpaid'; }else{ echo 'paid'; } ?></h5>
					...
					<table class="table">
						...
						<?php foreach ($transactions->result('transaction_model') as $transaction) { ?>
							 	...
							 	<tr>
							 			...
							 			<td><?php if($transaction->transactiontype){ ?>  <span class="label label-success">Debit &nbsp;</span> <?php } ?></td>

							 			<td><?php if($transaction->transactiontype == 0){ ?> <span class="label label-inverse">Credit</span> <?php } ?></td>

							 			<td colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $transaction->amounttransacted; ?></td>
					   ...
					   <?php  } ?>
						...
						<tfoot>
							<tr>
								...
								<td></td>
								<th>Total Balance:</th>
								<td>Ksh.<?php echo $customeraccount->balance; ?></td>
							</tr>
						</tfoot>
					</table>
				<?php }else{ ?>
					...
					<!--	  ////////here-->
						   <div class="control-group">
								...
								<div class="controls">
										...
										<input type="text" name="customer[dateOfBirth]" value="<?php echo $customer->dateOfBirth;?>" class="input-xxlarge" />
