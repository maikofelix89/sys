              ...
              <div class="control-group">
                      ...
                      <div class="controls">
								...
								<select name="charge" class="input-xlarge">
										...
										?>
								        <?php foreach($charges as $charge=>$name): ?>
										     <option value="<?php echo $charge; ?>" <?php if(array_key_exists('charge',$_POST) && $charge == $_POST['charge']) echo ' selected="selected"'; ?> > <?php echo $name; ?></option>
										<?php endforeach; ?>
								</select>
