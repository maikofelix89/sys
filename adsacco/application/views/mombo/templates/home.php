                    ...
                    <div class="stat-widget-container">
                        ...
                        <div class="stat-widget">
                            <div class="stat-button">
                                <p class="title">
                                     <?php echo number_format($principal_outstanding, 2, '.', ','); ?>
                                </p>
                                <p class="detail"> Outstanding Principal</p>
                            </div>
                        </div>
						<div class="stat-widget">
                            <div class="stat-button">
                                <p class="title">
                                   <?php echo number_format($interest_outstanding, 2, '.', ','); ?>
                                </p>
                                <p class="detail">Outstanding Interest</p>
                            </div>
                        </div>
                        <div class="stat-widget">
                            <div class="stat-button">
                                <p class="title">
                                    <?php echo number_format($charges_outstanding, 2, '.', ','); ?>
                                </p>
                                <p class="detail">Outstanding Penalties</p>
                            </div>
                        </div>
                        ...
                        <div class="stat-widget">
                            <div class="stat-button">
                                ...
                                <p class="detail">Total Amount Due</p>
                            </div>
                        </div>
                    </div>
                </div>
