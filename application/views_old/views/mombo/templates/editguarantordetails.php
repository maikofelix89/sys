<div class="header">
      <h1 class="page-title">Edit Guarantor</h1>
</div>
...
<ul class="breadcrumb">
	...
	<li>
	    <a href="<?php echo base_url().'gaurantors/'; ?>">Guarantor</a> 
	    <span class="divider">/</span>
	</li>
	<li class="active">Edit Guarantor details</li>
</ul>
...
<div class="btn-toolbar">
    ...
    <div class="btn-group pull-right">
      <a href="<?php echo base_url().'gaurantors/addnewgaurantor/';?>" class="btn btn-success"><i class="icon-plus"></i> New Guarantors</a>
    </div>
</div>
...
<?php } ?>
 ...
 <div class="well">
	  <div id="edit-gaurantor-form-cont">
				   <h4 class="btn-primary btn-large" style="margin-bottom:-4px;">Edit Customer Account</h4>
