...
class Mombo extends CI_Controller{
	...
	public function __construct()
	{
	 ...
	 public function home(){
			...
			$interest_outstanding= $this->chargestotalpayment_model->get_outstanding_interest();
			$charges_outstanding= $this->chargestotalpayment_model->get_outstanding_charges();
			...
			$this->msg['interest_outstanding'] = $interest_outstanding;
			$this->msg['charges_outstanding'] = $charges_outstanding;
