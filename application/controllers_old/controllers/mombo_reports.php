...
class Mombo_reports extends CI_Controller{
	...
	public function index($month = 0, $year = 0){ 
		...
		$this->page->title      = "Mombo Loan System | Mombo Reports";
		 
		$this->page->name       = 'mombo-mombo-reports';
		...
		$this->sendResponse($this->msg,array(
	    	...
	    	$this->header => $this->msg,
				...
				'mombo/templates/mombo_reports_view' => $this->msg,
