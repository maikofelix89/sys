<div class="header">
		...
		<?php if($criteria == 'income'){ ?> <h1 class="page-title">Income Accounts</h1> <?php } ?>
        ...
        <ul class="breadcrumb">
            ...
            <li class="active">
					...
					<?php if($criteria == 'income'){ ?> Income Accounts <?php } ?>
			            ...
			            <tbody>
			            		  ...
			            		  <?php $i=0; foreach($accounts->result('account_model') as $account){ ?>
			            				<tr>
												...
												<td> <?php echo (($account->is_income) ? "Yes" : "No"); ?> </td>
